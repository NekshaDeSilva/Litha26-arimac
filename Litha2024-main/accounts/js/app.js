...
var htmlJS={
    ...
    langHTML:'<div class="language-basket"><div class="small-bitbucket-loader-untill"></div><div class="languageBox" data-lang="si" role="button"><h3>Sinhala</h3></div><div class="languageBox" data-lang="en" role="button"><h3>English(UK)</h3></div><div class="languageBox" data-lang="es" role="button"><h3>Espanol</h3></div><div class="languageBox" data-lang="zh-CN" role="button"><h3>Chinese</h3></div><div class="languageBox" data-lang="ta" role="button"><h3>Tamil</h3></div><div class="languageBox" data-lang="hi" role="button"><h3>Hindi</h3></div><div class="languageBox" data-lang="cs" role="button"><h3>Czech</h3></div><div class="languageBox" data-lang="ja" role="button"><h3>Japanese</h3></div><div class="languageBox" data-lang="ru" role="button"><h3>Russian</h3></div><div class="languageBox" data-lang="en" role="button"><h3>English(US)</h3></div><div class="languageBox" data-lang="fr" role="button"><h3>French</h3></div></div>',
    title:'Language',
    expHTML:'<div class="helloncloud-div-pop-header">    <div class="helloncloud-div-pop-header_logo">    <img loading="lazy" class="helloncloud-div-pop-header_logo-icoset minicoset-helloncloud-div-pop-header_logo-icoset" src="./assets/static/litha-logo.png" draggable="false" alt="Litha">      </div>    </div><div class="helloncloud-div-pop-content">    <h3 class="helloncloud-div-pop-header_headline"><b>Hello</b>, welcome to Accounts.</h3>    <h3 class="helloncloud-div-pop-header_headline">Sign in for the Litha 2026 experience.</h3>    </div><div class="helloncloud-div-pop-footer">    <div class="getstartedbtn-helloncloud-pop-header" role="button">Explore</div>    <div class="bottom-crashcont-handleer-setdiv">        <li class="bottom-crashcont-handleer-setdiv-handlelink">Sign In</li>        <li class="bottom-crashcont-handleer-setdiv-handlelink">Explore</li>        <li class="bottom-crashcont-handleer-setdiv-handlelink">Troubleshoot</li>        <li class="bottom-crashcont-handleer-setdiv-handlelink">Developers</li>    </div></div>'
,   troubleHTML:' <div class="troubleshooter-win crzcotent-crashwarn"><div class="troubleshooter-win-top">    <span class="jhkhLVhVhbhv_">        <svg style="margin-right: .3rem;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-text-fill" viewBox="0 0 16 16">            <path d="M16 8c0 3.866-3.582 7-8 7a9.06 9.06 0 0 1-2.347-.306c-.584.296-1.925.864-4.181 1.234-.2.032-.352-.176-.273-.362.354-.836.674-1.95.77-2.966C.744 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7zM4.5 5a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1h-7zm0 2.5a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1h-7zm0 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4z"/>          </svg>          Search In Help Center</span>    <div class="troubleshooter-ext-search-frmN">        <form method="get">        <div class="troubleshooter-ext-search-frmN-left">            <input type="text" placeholder="Start Typing Here.."></div>        <div class="troubleshooter-ext-search-frmN-right">            <svg role="button" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="searchbtn-external-helpdesk-CUR" viewBox="0 0 16 16">                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>              </svg>        </div>        </form>    </div></div><div class="troubleshooter-win-bottom"><iframe src="./chat.html" style="width:100%; height:100%; border:0;outline:0;"></div></div>',
    ...
    <div class="signIn-box">
        <div class="signIn-Box_inner signIn-1Box" data-imp="First_name">
            ...
            <input id="Fname" type="text" placeholder="Dasun " class="inputBox-signIn firstName_accuire_inputNormalpreset">
        </div>
        <div class="signIn-Box_inner signIn-2Box" data-imp="Last_name">
            <div class="headerText_bool-welcome">Last Name</div>
            <input id="Lname" type="text" placeholder="Shanake " class="inputBox-signIn lastName_accuire_inputNormalpreset">
        </div>
        <div class="signIn-Box_inner signIn-3Box" data-imp="Email_id">
            <div class="headerText_bool-welcome">Email</div>
            <input type="email" id="Email"  placeholder="dasuns@icc-cricket.com" class="inputBox-signIn email_accuire_inputNormalpreset">
        </div>
        <div class="signIn-Box_inner signIn-4Box" data-imp="Description">
            <div class="headerText_bool-welcome">Bio</div>
            <input type="text" id="bio"  placeholder="Hello, I'm Igniting my mind these days!" class="inputBox-signIn des_accuire_inputNormalpreset">
        </div>
        ...
        <div class="signIn-Box_inner signIn-6Box" style="align-items: center;" data-imp="TermsConditions_path">
            ...
            <div class="overlayDiv-tandcviewer_controlCpanel">
                <b>Copyright © 2026 Litha 2026. Created by Neksha DeSilva.</b><br> By continuing, you agree to a general privacy and usage policy for this product. Information you enter may be stored to provide account access, posting, personalization, and synchronization across supported devices. Do not upload unlawful, abusive, or harmful content. Accounts and content that abuse the service may be limited or removed. This product is provided as-is, and you are responsible for the information you choose to publish or share.
            </div>
                ...
                <div class="welComeDiv-ncloud-signin-Comp-inner" >
                    ...
                    <span class="userId_preview_descorp--dd-d">
                        User
                            ...
                            <img data-inlineCSS="yes" title="Verified Account" src="./assets/static/patchverified.png" style="width: 1.5rem; " class="accountNVerified_badge" alt="Untititled" draggable="false" loading="lazy" onerror="this.src='./assets/static/patch_verfied.png'">
...
function change_role(handleer = '.ncloud-rolechange', handleerS = 'langHTML' , setstatus=1 ){
    ...
    $('.transparent-hellonclopud-header-navigation-right span').text(bestKeywordValue_definer);

    function bestKeywordValue_definerfind(){
        if(bestKeywordValue_definer == 'troubleHTML'){
            bestKeywordValue_definer = 'Troubleshoot'
    ...
    if(setstatus == 9){
        ...
        $('.languageBox').on('click', function(){
            ...
            if (window.LithaTranslate && window.LithaTranslate.setLanguage) {
                window.LithaTranslate.setLanguage(langCode);
            }
        });
